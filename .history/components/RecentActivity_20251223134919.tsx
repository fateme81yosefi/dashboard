        ...
        {activities.map((activity, index) => {
          ...
          return (
            ...
            >
              ...
              {/* Activity Card */}
              <div className={`relative right-8 mr-4 bg-gradient-to-br ${activity.bgGradient} dark:bg-gray-800/50 backdrop-blur-sm rounded-2xl p-5 border ${activity.borderColor} shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-x-1 group-hover:scale-[1.02]`}>
                {/* Shine Effect */}
