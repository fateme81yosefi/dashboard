...
const menuItems = [
  { icon: 'streamline-freehand:dashboard-browser-gauge', labelKey: 'dashboard' as const, href: '/' },
  { icon: 'lucide:users', labelKey: 'users' as const, href: '/users' },
  { icon: 'lucide:bar-chart-3', labelKey: 'reports' as const, href: '/reports' },
  { icon: 'lucide:file-text', labelKey: 'docs' as const, href: '/docs' },
  { icon: 'lucide:trending-up', labelKey: 'analytics' as const, href: '/analytics' },
  { icon: 'lucide:bell', labelKey: 'notifications' as const, href: '/notifications' },
