        ...
        <div className="flex flex-col h-full">
          ...
          <div className={cn(
            ...
            <button
              ...
              title={isCollapsed ? t('expand') || 'باز کردن' : t('collapse') || 'بستن'}
            >
              {isCollapsed ? (
              ...
              {menuItems.map((item) => {
                ...
                return (
                  ...
                  >
                    ...
                    {isCollapsed && (
                      <div className="absolute right-full mr-2 px-3 py-2 bg-gray-900 dark:bg-gray-700 text-white text-sm rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none whitespace-nowrap z-50 shadow-lg">
                        {t(item.labelKey)}
                        <div className="absolute right-0 top-1/2 transform translate-x-full -translate-y-1/2 border-4 border-transparent border-r-gray-900 dark:border-r-gray-700"></div>
                      </div>
                    )}
                  </Link>
                )
