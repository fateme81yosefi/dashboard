  ...
  return (
    <div className="relative bg-white dark:bg-gray-800 rounded-2xl shadow-xl hover:shadow-2xl border border-gray-200/50 dark:border-gray-700/50 p-6 md:p-8 transition-all duration-500 overflow-hidden">
      ...
      <div className="relative z-10 flex items-center justify-between mb-8">
        ...
        <button className="group flex items-center space-x-2 space-x-reverse text-sm font-semibold text-primary-600 dark:text-primary-400  dark:hover:text-primary-300 px-4 py-2 rounded-xl hover:bg-primary-50 dark:hover:bg-primary-900/20 transition-all duration-300 hover:scale-105">
          <span>{t('viewAll')}</span>
