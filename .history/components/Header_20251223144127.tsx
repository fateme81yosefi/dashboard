    ...
    <header className="bg-white dark:bg-gray-800 shadow-sm border-b border-gray-200 dark:border-gray-700 transition-colors duration-300">
      <div className="flex items-center justify-between px-6 py-4">
        ...
        <div className="flex items-center space-x-3 space-x-reverse">
          ...
          >
            <Icon icon="lucide:languages" className="w-5 h-5" />
          ...
          >
            {theme === 'dark' ? (
              <Icon icon="lucide:sun" className="w-5 h-5 transition-transform duration-200 hover:rotate-12" />
            ) : (
              <Icon icon="lucide:moon" className="w-5 h-5 transition-transform duration-200 hover:rotate-12" />
            )}
          </button>
