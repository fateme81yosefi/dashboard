...
export default function RecentActivity() {
  ...
  return (
    <div className="relative bg-white dark:bg-gray-800 rounded-2xl shadow-xl hover:shadow-2xl border border-gray-200/50 dark:border-gray-700/50 p-6 md:p-4 transition-all duration-500 overflow-hidden">
          ...
          return (
            ...
            >
              ...
              <div className="absolute right-6 top-0 bottom-0 flex flex-col items-center">
                {/* Timeline Dot */}
                <div className={`relative z-20 w-4 h-4 rounded-full bg-gradient-to-br ${activity.gradient} shadow-lg ring-4 ring-white dark:ring-gray-800 group-hover:scale-125 transition-transform duration-300`}>
                  <div className="absolute inset-0 rounded-full bg-white/30 animate-ping"></div>
                </div>
                
                {/* Timeline Line */}
                {!isLast && (
                  <div className="absolute top-6 bottom-0 w-0.5 bg-gradient-to-b from-gray-200 via-gray-300 to-transparent dark:from-gray-700 dark:via-gray-600 group-hover:from-primary-400 group-hover:via-primary-500 group-hover:to-primary-600 transition-all duration-500"></div>
                )}
              </div>
              
              {/* Activity Card */}
              <div className={`relative right-8 mr-4 bg-gradient-to-br ${activity.bgGradient} dark:bg-gray-800/50 backdrop-blur-sm rounded-2xl p-2 border ${activity.borderColor} shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-x-1 group-hover:scale-[1.02]`}>
                {/* Shine Effect */}
