export const translations = {
  fa: {
    ...
    dashboardDescription: 'مدیریت و نظارت کامل بر سیستم خود را در یک مکان داشته باشید',
    ...
    loginDescription: 'برای دسترسی به داشبورد وارد شوید',
    ...
    agreeToTerms: 'با شرایط و قوانین موافقم',
  ...
  en: {
    ...
    dashboardDescription: 'Manage and monitor your entire system in one place',
